...
type Section = 'road' | 'progression' | 'wheel' | 'inventory' | 'workshop' | 'shop' | 'tasks' | 'friends' | 'battlepass';
        ...
        {loading ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12, paddingBottom: 8 }}>
            <div style={{
              ...
              <div style={{ color: 'var(--ll-text)', fontWeight: 1000, fontSize: 15 }}>✨ Progression Hub</div>
              <div style={{ color: 'var(--ll-text-soft)', fontSize: 12, marginTop: 4 }}>
                Manage your passive rewards, daily chest, and season prestige here without crowding the rest of Chrono Empires.
              </div>
            </div>
